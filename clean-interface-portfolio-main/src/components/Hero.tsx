  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed stagger-delay-2">
          Especialista em Front-End com 2 anos de experiência, apaixonado por criar interfaces de usuário intuitivas e funcionais.
        </p>
